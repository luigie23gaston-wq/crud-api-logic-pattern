            ...
            tr.innerHTML = `
                ...
                <td class="px-4 py-3">
                    <div class="action-set">
                        <button class="action-btn view" data-inline-view="${rec.id}" title="View"><i class="fa fa-eye"></i></button>
                        <button class="action-btn edit" data-inline-edit="${rec.id}" title="Edit"><i class="fa fa-edit"></i></button>
                        <button class="action-btn trash" data-inline-trash="${rec.id}" title="Trash"><i class="fa fa-trash"></i></button>
                    </div>
                </td>
            `;
