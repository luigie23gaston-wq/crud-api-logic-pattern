...
<div id="upload-progress-component" class="upload-progress-wrap hidden">
  <!-- File Uploading Progress Form -->
  <div class="upload-file-card">
    <div class="mb-2 flex justify-between items-center">
      <div class="flex items-center gap-x-3">
        <span class="size-8 flex justify-center items-center border border-gray-200 text-gray-500 rounded-lg upload-icon">
          <!-- SVG icon (kept inline SVG for component) -->
        ...
        <div>
          <p class="text-sm font-medium text-gray-800 upload-filename">preline-ui.xls</p>
          <p class="text-xs text-gray-500 upload-size">7 KB</p>
        </div>
      </div>
      <div class="inline-flex items-center gap-x-2">
        <span class="relative upload-status-icon">
  ...
  <button type="button" data-upload-cancel class="relative text-gray-500 hover:text-gray-800 focus:outline-hidden focus:text-gray-800 disabled:opacity-50 disabled:pointer-events-none upload-cancel-btn" aria-label="Cancel upload">
    ...
    <div class="flex items-center gap-x-3 whitespace-nowrap">
      <div class="flex w-full h-2 bg-gray-200 rounded-full overflow-hidden progress-bar-track" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
        <div class="flex flex-col justify-center rounded-full overflow-hidden bg-teal-500 text-xs text-white text-center whitespace-nowrap progress-bar-fill" style="width: 0%"></div>
      </div>
      <div class="w-6 text-end">
        <span class="text-sm text-gray-800 progress-percent">0%</span>
      </div>
    </div>
    <!-- End Progress Bar -->
  </div>
